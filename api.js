...
export const getBoosterGrants = (from, to, childId = null) => {
  let q = sb.from('booster_grants').select('*, children(first_name, color)')
    .gte('period_start', from).lte('period_start', to).order('granted_at', { ascending: false });
...
export const evaluateCurrentBoosters = () => rpc('evaluate_current_boosters', {});
